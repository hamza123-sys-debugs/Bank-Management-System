...
public:
    ...
    void createAccount() {
        ...
        saveAccountsToFile(); // Save accounts to file after creating a new account
    }
    ...
    void processDeposit(int accNo, double amount) {
        ...
        saveAccountsToFile(); // Save accounts to file after deposit
    }
    ...
    void processWithdrawal(int accNo, double amount) {
        ...
        saveAccountsToFile(); // Save accounts to file after withdrawal
    }
    ...
    void removeAccountHolder() {
        ...
        saveAccountsToFile(); // Save accounts to file after removal
    }
    ...
    void updateAccountDetails() {
        ...
        saveAccountsToFile(); // Save accounts to file after updating
    }
};
